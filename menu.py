...
main_menu.add(
    types.InlineKeyboardButton(text='🔪 Товары 🔪', callback_data='catalog'),
    types.InlineKeyboardButton(text='🔪 Профиль 🔪', callback_data='profile'),
    types.InlineKeyboardButton(text='🔪️ Информаци 🔪я', callback_data='info'),
    types.InlineKeyboardButton(text='🔪 Мои покупки 🔪', callback_data='purchases'),
    types.InlineKeyboardButton(text='🔪 Пополнение 🔪', callback_data='replenish_balance'),
    types.InlineKeyboardButton(text='🔪 Топовая тима', callback_data='ads')
)
main_menu.add(
...
admin_menu.add(types.InlineKeyboardButton(text='Настройка инфы', callback_data='admin_info_settings'))
admin_menu.add(
...
back_to_admin_menu.add(
    types.InlineKeyboardButton(text='Админка', callback_data='back_to_admin_menu')
)
